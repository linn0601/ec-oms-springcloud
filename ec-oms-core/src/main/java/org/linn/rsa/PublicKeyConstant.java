...
public final class PublicKeyConstant {
	...
	private static final String PUBLIC_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAiAHLS7HpSiI9v1a2Mw73WS0p6soJRj"
	 ...
	 * jwt中存储用户信息的key
	 */
	public static final String JWT_USER_INFO_KEY = "ec-oms-user";
